...
| geodesic | Fréchet mean |
|:----------|:-----------|
|``\textrm{exp}\big(b\textrm{log}P + a\textrm{log}Q\big)``| ``\textrm{exp}\big(\sum_{i=1}^{k}w_i\hspace{1pt}\textrm{log}P_i\big)``|
...
**geodesic**: ``TT^H``, where 
``T=S_P+a(S_Q-S_P)+D_P\hspace{2pt}\textrm{exp}\big(a\textrm{log}D_Q-a\textrm{log}D_P\big)``
