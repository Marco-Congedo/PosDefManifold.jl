...
In Windows, if you use VScode, set the desired number of threads by editing the *settings.json* file, found in the menu File>Preferences>Settings
and searching for `julia num Threads`.
