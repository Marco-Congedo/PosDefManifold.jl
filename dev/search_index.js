...

{
    ...
    "title": "𝔻Vector type",
    "category": "section",
    "text": "𝔻Vector=Vector{𝔻}This is a vector of Diagonal matrices, alias of DiagonalVector.   Julia sees is at: Array{Diagonal,1}.See aliases for the 𝔻 symbol and typecasting matrices for the use of Diagonal matrices in PosDefManifold.𝔻Vector₂ type𝔻Vector₂=Vector{𝔻Vector} is a vector of 𝔻Vector type objects, i.e., a vector of vectors of Diagonal matrices.  It is the alias of DiagonalVector₂.  Julia sees it as: Array{Array{Diagonal,1},1}. Note that 𝔻Vector₂ is not a matrix of Hermitian matrices since the several ℍVector objects it holds do not need to have the same length."
},
...
{
    "location": "MainModule/#BLAS-routines-1",
    "page": "MainModule (PosDefManifold.jl)",
    "title": "BLAS routines",
    "category": "section",
    "text": "Some functions in PosDefManifold call BLAS routines for optimal performnce. This is reported in the help section of the concerned functions. When this is the case, you can set the number of threads the BLAS library should use by:using LinearAlgebra\nBLAS.set_num_threads(n)where n is the number of threads. By default, PosDefManifold emplys 3/4 of the threads available on your computer rounded to the nearest integer."
},
...

{
    ...
    "category": "section",
    "text": "Function Description\nfDiagonal, 𝑓𝔻 Elemen-wise functions of matrix diagonals⋅fDiagonal"
},
