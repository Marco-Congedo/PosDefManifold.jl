...

{
    ...
    "category": "function",
    "text": "quadraticForm(v::Vector{T}, X::Matrix{T}) where T<:RealOrComplex\n\nalias: qufo\n\nGiven a vector v and a matrix X, compute the quadratic form\n\nv^*Xv.\n\nv and X may be real or complex. If they are real, only the  lower triangular part of X is used.\n\nX may be a generic Matrix, may be flagged by Julia as an Hermitian  matrix or as a LowerTriangular matrix. In the latter case it must be real.\n\nMath\n\nFor v and X real, the quadratic form is\n\n`sum_i(v_i^2x_ii)+sum_ij(2v_iv_jx_ij).\n\nExamples\n\nusing PosDefManifold\nP=randP(5) # generate a random real positive definite matrix 5x5\nv=randn(5)\nq1=quadraticForm(v, P) # or q1=quad(v, P)\n# obtain a lower Triangular view of P\nL=LowerTriangular(Matrix(P)) # or L=𝕃(Matrix(P))\nq2=quadraticForm(v, L)\nq1 ≈ q2 ? println(\" ⭐ \") : println(\" ⛔ \")\n\n\n\n\n\n"
},
