...

{
    ...
    "title": "BLAS routines",
    "category": "section",
    "text": "Some functions in PosDefManifold call BLAS routines for optimal performnce. This is reported in the help section of the concerned functions. When this is the case, you can set the number of threads the BLAS library should use by:using LinearAlgebra    BLAS.setnumthreads(n)where n is the number of threads. By default, PosDefManifold emplys 3/4 of the threads available on your computer rounded to the nearest integer."
},
...

{
    ...
    "category": "function",
    "text": "det1(X::𝕄)\ndet1(X::ℍ)\n\nGiven a real or complex square Matrix or Hermitian matrix X,  return the best approximant to  X from the set of matrices in the special linear group,  i.e., the closer matrix having det=1. See Bhatia and Jain (2014)[🎓].\n\nSee det.\n\nSee also: tr1.\n\nExamples\n\nusing LinearAlgebra, PosDefManifold\nP=randP(5) # generate a random real positive definite matrix 5x5\nQ=det1(P)\ndet(Q) # must be 1\n\n\n\n\n\n"
},
...

{
    ...
    "category": "function",
    "text": "pow(P::ℍ, p)        # one argument\npow(P::ℍ, args...)  # several arguments\n\nGiven a positive definite Hermitian matrix P, return the power  P^r_1 P^r_2  for any number of exponents r_1 r_2.  It returns a tuple of as many elements as arguments passed after P.\n\nP must be flagged as Hermitian. See typecasting matrices.\n\nArguments (P, arg1, arg2,...)\n\nP is a positive matrix.\narg1 arg2 are real numbers.\n\nSee also: invsqrt.\n\nExamples\n\nusing LinearAlgebra, PosDefManifold\nP=randP(5);     # use P=randP(ComplexF64, 5) for generating an Hermitian matrix\nQ=pow(P, 0.5);            # =>  QQ=P\nQ, W=pow(P, 0.5, -0.5);\nW*P*W ≈ I ? println(\" ⭐ \") : println(\" ⛔ \")\nQ*Q ≈ P ? println(\" ⭐ \") : println(\" ⛔ \")\nR, S=pow(P, 0.3, 0.7);\nR*S ≈ P ? println(\" ⭐ \") : println(\" ⛔ \")\n\n\n\n\n\n"
},
...

{
    ...
    "category": "function",
    "text": "choL(P::ℍ)\n\nGiven a real or complex positive definite Hermitian matrix P,  return the Cholesky lower triangular factor L  such that LL=P. To obtain L or both L and L, use instead  julia function cholesky(P).\n\nOn output, L is of type LowerTriangular.\n\nExamples\n\nusing PosDefManifold\nP=randP(5);\nL=choL(P);\nL*L\'≈ P ? println(\" ⭐ \") : println(\" ⛔ \")\n\n\n\n\n\n"
},
