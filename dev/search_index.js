...

{
    ...
    "title": "𝔻Vector type",
    "category": "section",
    "text": "𝔻Vector=Vector{𝔻}This is a vector of Diagonal matrices, alias of HermitianVector.   Julia sees is at: Array{Diagonal,1}.See aliases for the 𝔻 symbol and typecasting matrices for the use of Diagonal matrices in PosDefManifold.𝔻Vector₂ type𝔻Vector₂=Vector{𝔻Vector} is a vector of 𝔻Vector type objects, i.e., a vector of vectors of Diagonal matrices.  It is the alias of DiagonalVector₂.  Julia sees it as: Array{Array{Diagonal,1},1}. Note that 𝔻Vector₂ is not a matrix of Hermitian matrices since the several ℍVector objects it holds do not need to have the same length."
},
