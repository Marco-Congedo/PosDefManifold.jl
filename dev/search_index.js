...

{
    ...
    "category": "function",
    "text": "function typeofVector(array::Union{ AnyMatrixVector,\n                                    AnyMatrixVector₂ })\n\nalias: typeofVec\n\nReturn the type of a Vector, either HermitianVector,  DiagonalVector, LowerTriangularVector, or MatrixVector.  Argument array may be a vector of one of these types, but also one of the following:\n\nℍVector₂, 𝔻Vector₂, 𝕃Vector₂, 𝕄Vector₂.\n\nThose are Array of Matrices types.  See also aliases for the symbols ℍ, 𝔻, 𝕃 and 𝕄.\n\nNote that this function is different from Julia function  typeof  only in that it returns the vector type also for  ℍVector₂, 𝔻Vector₂, 𝕃Vector₂ and 𝕄Vector₂ types.\n\nExamples\n\nusing LinearAlgebra, PosDefManifold\nP=randP(3, 4) # generate 4 3x3 Hermitian matrix\ntypeofMatrix(P) # returns `Array{Hermitian,1}`\ntypeof(P) # also returns `Array{Hermitian,1}`\n\n\n\n\n\n"
},
...

{
    ...
    "category": "section",
    "text": "Function Description\nfVec general function for multi-threaded computation of means and sums of matrix vectors⋅fVec"
},
